...
sed -i "/^\\s*\\$border_active_color/c\\    \$border_active_color = $ACTIVE_BORDER_RGBA" "$HYPR_CONFIG"
sed -i "/^\\s*\\$border_inactive_color/c\\    \$border_inactive_color = $INACTIVE_BORDER_RGBA" "$HYPR_CONFIG"